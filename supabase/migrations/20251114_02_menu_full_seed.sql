...
('SALATALAR / SALATE', 'SALATALAR / SALATE', 2, true),
('SICAK İÇECEKLER / WARME GETRÄNKE', 'SICAK İÇECEKLER / WARME GETRÄNKE', 3, true),
('BALIK / FISCH', 'BALIK / FISCH', 4, true),
('PIDE / TEIGSCHIFFCHEN', 'PIDE / TEIGSCHIFFCHEN', 5, true),
('KIDS MENU', 'KIDS MENU', 6, true),
('TATLI / DESSERTS', 'TATLI / DESSERTS', 7, true),
('İÇECEKLER / KALTE GETRÄNKE', 'İÇECEKLER / KALTE GETRÄNKE', 8, true),
('MEZELER / VORSPEISEN', 'MEZELER / VORSPEISEN', 9, true),
('ARA SICAKLAR / ZWISCHENSPEISEN', 'ARA SICAKLAR / ZWISCHENSPEISEN', 10, true),
('LAHMACUN / TÜRKISCHE PIZZA', 'LAHMACUN / TÜRKISCHE PIZZA', 11, true),
('IZGARA ÇEŞİTLERİ / GRILLSPEZIALITÄTEN', 'IZGARA ÇEŞİTLERİ / GRILLSPEZIALITÄTEN', 12, true),
('YOĞURTLULAR / MIT JOGHURT', 'YOĞURTLULAR / MIT JOGHURT', 13, true),
('DUBLE ŞİŞLER / DOUBLE SPIEẞ', 'DUBLE ŞİŞLER / DOUBLE SPIEẞ', 14, true),
('SAÇ TAVALAR / PFANNENGERICHTE', 'SAÇ TAVALAR / PFANNENGERICHTE', 15, true),
('DÖNER & DÜRÜM', 'DÖNER & DÜRÜM', 16, true),
('PIZZA', 'PIZZA', 17, true),
('PIZZABRÖTCHEN', 'PIZZABRÖTCHEN', 18, true),
('EXTRA BEILAGEN', 'EXTRA BEILAGEN', 19, true);
