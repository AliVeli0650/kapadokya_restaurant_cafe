        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link 
              ...
              className="bg-white p-6 border border-gray-200 hover:border-gray-900 transition-all text-center group"
            >
              <svg className="w-12 h-12 mx-auto mb-4 text-gray-400 group-hover:text-gray-900 transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm uppercase tracking-wide font-light">WhatsApp Ayarları</p>
            </Link>
